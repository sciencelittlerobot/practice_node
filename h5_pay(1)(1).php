...
<div class="main">
    <div class="form">
        <p><?= __('请确认微信支付是否已完成'); ?></p>
        <div class="btn">
            <a href="<?=Yf_Registry::get('paycenter_api_url')?>?ctl=Info&met=wx_paystatus&order_id=<?=$order_id?>"><?= __('已完成支付'); ?></a>
        </div>
        <div class="btn">
            <a class="s_btn" href="<?=Yf_Registry::get('paycenter_api_url')?>?ctl=Info&met=wx_paystatus&order_id=<?=$order_id?>"><?= __('支付遇到问题，重新支付'); ?></a>
        </div>
    </div>
</div>
